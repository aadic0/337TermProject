...
void saveData(const std::string& filename, const std::string& flightID, int numRow, int numCol, const std::vector<std::string>& lastNames, const std::vector<std::string>& firstNames, const std::vector<std::string>& phoneNumbers, const std::vector<std::string>& seatNumbers, const std::vector<std::string>& passengerIDs);
